...
const seedProjects: ProjectRecord[] = [
  {
    ...
    month: 'November',
    successCount: 0,
    topAchievement: 'Almost successful But "Nearly cannot kill a bird"',
    assurancePct: 5,
    notes: 'Github Restrict community function',
  },
  {
    id: '2',
    ...
    month: 'December',
    successCount: 0,
    topAchievement: 'solana cracking',
    assurancePct: 2,
    notes: 'uncompleted progress',
  },
  {
    id: '3',
    ...
    month: 'febuary',
    successCount: 0,
    topAchievement: 'ungoing',
    assurancePct: 30,
    notes: 'cracking ETH wallet',
  },
];
